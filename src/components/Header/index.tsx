...
const Header = () => {
  ...
  return (
    <div className="sm:h-16 flex flex-col sm:flex-row items-start justify-between sm:items-center">
      <XMarkIcon onClick={closeSurvey} className="h-5 w-5 rounded-md hover:shadow-inner shadow-black hover:dark:shadow-gray-500 text-dark-100 dark:text-light-100" />
